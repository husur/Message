...
class RegisterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let gesture = UITapGestureRecognizer(target: self,
                                             action: #selector(didTapChangeProfilPic))
        imageView.addGestureRecognizer(gesture)
    }
    
    @objc private func didTapChangeProfilPic(){
    ...
    @objc private func registerButtonTapped(){
        ...
        DatabaseManager.shared.userExist(with: safeEmail, completion: { [weak self] exists in
            ...
            guard !exists else{
                ...
                strongSelf.alertUserLoginError(message: "Un utilisateur a déjà été créé avec cet email")
                return
            }
            ...
            FirebaseAuth.Auth.auth().createUser(withEmail: email, password: password, completion: { authResult, error in
                ...
                guard authResult != nil, error == nil else{
                    strongSelf.alertUserLoginError(message: "Un utilisateur a déjà été créé avec cet email")
                    print("Une erreur est survenue dans la creation de l'utilisateur")
                    return
                }
    ...
    func alertUserLoginError(message: String = "Veuillez rentrer toutes les informations pour vous inscrire") {
...
extension RegisterViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func presentPhotoActionSheet() {
        let actionSheet = UIAlertController(title: "Photo de profil",
                                            message: "Comment voulez vous selectionnez une photo ?",
